  ...
  return (
    <>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-900">{rowData.EMP_COUNT}</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className={`bg-white rounded-lg border-2 p-4 ${HIERARCHY ? 'border-blue-200 bg-blue-50' : 'border-purple-200 bg-purple-50'}`}>
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="font-medium text-gray-900 mb-1">
                {HIERARCHY ? 'Hierarchy-Based Approval' : 'Direct Project Manager Approval'}
              </p>
